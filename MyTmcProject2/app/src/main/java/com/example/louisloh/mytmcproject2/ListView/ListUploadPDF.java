...
import com.example.louisloh.mytmcproject2.Adapter.PdfAdapter;
import com.example.louisloh.mytmcproject2.FilePath;
...
public class ListUploadPDF extends AppCompatActivity implements View.OnClickListener {
    //Declaring views
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_upload_pdf);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(ListUploadPDF.this,obj.getString("message"), Toast.LENGTH_SHORT).show();
                            ...
                            pdfAdapter=new PdfAdapter(ListUploadPDF.this,R.layout.list_layout, pdfList);
